...
# define _CFFI_PYTHON_STARTUP_FUNC  PyInit_test_xll
#else
# define _CFFI_PYTHON_STARTUP_FUNC  inittest_xll
#endif
...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 3), // int(__stdcall )(void)
/*  1 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 2),
/*  2 */ _CFFI_OP(_CFFI_OP_POINTER, 0), // int(__stdcall *)(void)
...
CFFI_DLLEXPORT int _cffi_stdcall xlAutoClose(void)
{
  char a[8];
  char *p = a;
  _cffi_call_python(&_cffi_externpy__xlAutoClose, p);
  return *(int *)p;
}
...
CFFI_DLLEXPORT int _cffi_stdcall xlAutoOpen(void)
{
  char a[8];
  char *p = a;
  _cffi_call_python(&_cffi_externpy__xlAutoOpen, p);
  return *(int *)p;
}

static const struct _cffi_global_s _cffi_globals[] = {
  { "xlAutoClose", (void *)&_cffi_externpy__xlAutoClose, _CFFI_OP(_CFFI_OP_EXTERN_PYTHON, 2), (void *)xlAutoClose },
  { "xlAutoOpen", (void *)&_cffi_externpy__xlAutoOpen, _CFFI_OP(_CFFI_OP_EXTERN_PYTHON, 2), (void *)xlAutoOpen },
};
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_test_xll(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_test_xll(void) { return NULL; }
#  else
     inittest_xll(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit_test_xll(void)
{
  return _cffi_init("test_xll", 0x2701, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
inittest_xll(void)
